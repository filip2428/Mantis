...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      whileInView={{ backgroundSize: "100% 100%" }} // vezi pct. 2
      transition={{ duration: 2, ease: "linear", delay: 0.1 }}
      viewport={{ once: true, amount: 0.4 }} // vezi pct. 2
      style={{
      ...
      className={cn(
        // verde (emerald/lime) în loc de indigo/purple
        "relative inline-block rounded-lg bg-gradient-to-r from-emerald-300 to-lime-300 px-1 pb-1 dark:from-emerald-500 dark:to-lime-500",
        className
      )}
    >
      {children}
