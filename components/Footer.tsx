        ...
        <div className="grid grid-cols-2 gap-12 border-b border-white/20 pb-10 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="col-span-1">
            ...
            <div className="mb-4 flex space-x-4 text-white">
              {SOCIAL_LINKS.map((link) => (
                <a
                  ...
                  className="transition-colors hover:text-mantis-leaf-200"
            ...
            <div className="space-y-2 text-mantis-cream/80">
              ...
              <div className="flex items-center text-sm font-sans">
                <Mail className="mr-2 h-4 w-4 flex-shrink-0 text-mantis-leaf-200" />
                <a
          ...
          <div className="col-span-2 space-y-4 lg:col-span-1">
            ...
            <Link
              ...
              className="inline-flex items-center rounded-full bg-white px-4 py-2 text-sm font-semibold text-mantis-green-700 shadow-sm transition duration-300 hover:bg-mantis-cream"
            >
              Contactează-ne
            </Link>
          </div>
